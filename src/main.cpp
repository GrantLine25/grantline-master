...
const string strMessageMagic = "grantline Signed Message:\n";
...
// grantline: attempt to generate suitable proof-of-stake
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "grantline", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "GRANTLINE COIN GTL";
        CTransaction txNew;
        txNew.nTime = 1506506684;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0xbf26eb3c6021652c23a3932c26be22fbbee5ea506b4ef43053b33b7a3ff2ff93"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xb5, 0xb1, 0xc4, 0xf1 };
