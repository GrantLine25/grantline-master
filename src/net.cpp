...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "grantline " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
    {"80.209.239.94", "80.209.239.94"},
    {"80.209.239.95", "80.209.239.95"},
    {"80.209.239.92", "80.209.239.92"},
    {"80.209.239.96", "80.209.239.96"},
    {"80.209.239.97", "80.209.239.97"},
};

void ThreadDNSAddressSeed(void* parg)
{
    // Make this thread recognisable as the DNS seeding thread
    RenameThread("grantline-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("grantline-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("grantline-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("grantline-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. grantline is probably already running."), addrBind.ToString().c_str());
        else
